import Imagen1 from "../assets/galeria/2023-01-22_00.29.03.png";
import Imagen2 from "../assets/galeria/2023-01-22_22.07.31.png";
import Imagen3 from "../assets/galeria/2023-06-14_00.02.00.png";
...
export const SwipeCarousel = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-pink-100 py-3 rounded-xl">
      <motion.div
        drag="x"
        dragConstraints={{
          left: 0,
      ...
      {imgs.map((imgSrc, idx) => {
        return (
          <motion.div
            ...
            transition={SPRING_OPTIONS}
            className="aspect-video w-[100%] shrink-0 rounded-xl object-cover mx-auto"
          />
        );
      })}
    </>
